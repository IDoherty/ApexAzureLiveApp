...
func azureFragsDevList(numDevices int, azureIn structs.AzureChanStruct, devTable []structs.ApexLookupTable, fragChan chan<- structs.AzureOutputStruct) {

	//Process Incoming Metrics into Azure Fragments

	// Build Processing Structs and Flag
	var azureFragIDs structs.AzureFragIDDevList
